...
private const val PATH_RESOURCES = "./inputs/$YEAR/day%s/"
private const val URL_FORMAT_INPUT = "https://adventofcode.com/$YEAR/day/%d/input"
...
suspend fun makeSureInputFileIsAvailable(day: Int): Boolean {
    ...
    if (response.status == HttpStatusCode.NotFound) {
        println("⚠️ 4️⃣0️⃣4️⃣ - Challenge input is not available yet")
    ...
    inputFile.writeBytes(response.body<ByteArray>())
    return true
}
